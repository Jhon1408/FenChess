...
public class Rook extends Pieces {
    public Rook(Game game, Board board, String type, int x, int y) {
        this.game = game;
        this.board = board;
        ...
        if("r".equals(this.type)) {
            this.sprite = new ImageIcon(new ImageIcon("Images/b_rook.png").getImage().getScaledInstance(sizeX/9, sizeY/9, Image.SCALE_DEFAULT));
        } else {
            this.sprite = new ImageIcon(new ImageIcon("Images/w_rook.png").getImage().getScaledInstance(sizeX/9, sizeY/9, Image.SCALE_DEFAULT));
        }
        this.x = x;
        this.y = y;
